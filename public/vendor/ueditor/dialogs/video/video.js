...
(function(){
    ...
    function insertSingle(){
        ...
        if(!width.value) width.value = '640';
        if(!height.value) height.value = '360';
        var html = '<iframe frameborder="0" src="'+convert_url(url)+'" width="'+width.value+'" height="'+height.value+'"></iframe>';
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
            ...
            .replace(/vimeo.com\/(\w+)$/i, "player.vimeo.com/video/$1");
    ...
    function createPreviewVideo(url){
        ...
        '<iframe class="previewVideo" frameborder="0" src="' + conUrl + '" width="420" height="280" class="note-video-clip"></iframe>';
