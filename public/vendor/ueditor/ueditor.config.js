 ...
 */
/**************************提示********************************
 * 所有被注釋的配置項均為UEditor默認值。
 * 修改默認配置請首先確保已經完全明確該參數的真實用途。
 * 主要有兩種修改方案，一種是取消此處注釋，然後修改成對應參數；另一種是在實例化編輯器時傳入對應參數。
...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'source', 'preview', 'searchreplace', 'drafts', 'help'
        ]]
        ...
        //insertorderedlist
        //有序列表的下拉配置,值留空時支持多語言自動識別，若配置值，則以此值為准
        ,'insertorderedlist':{
            'decimal' : '1,2,3...'
        }
        //,'insertorderedlist':{
        ...
        //insertunorderedlist
        //無序列表的下拉配置，值留空時支持多語言自動識別，若配置值，則以此值為准
        ...
        //paragraph
        //段落格式 值留空時支持多語言自動識別，若配置，則以配置值為准
        ...
        //右鍵菜單的內容，可以參考plugins/contextmenu.js裡邊的默認菜單的例子，label留空支持國際化，否則以此配置為准
        //,contextMenu:[
        //    {
        //        label:'',       //顯示的名稱
        ...
        //webAppKey 百度應用的APIkey，每個站長必須首先去百度官網注冊一個key後方能正常使用app功能，注冊介紹，http://app.baidu.com/static/cms/getapikey.html
        //, webAppKey: ""
